...
class FollowLine(Node):
    ...
    def __init__(self, drone_type: str = "bebop"):
    ...
    def callback_control_center_x(self, msg: Float32):
        self.control_value_center_x = msg.data
        self.control_activate["center_x"] = True

    def callback_control_angle(self, msg: Float32):
    ...
    def apply_control(self):
        ...
        if self.should_apply_control("angle", self.control_value_angle, 0.1):
    ...
    def should_apply_control(
        self, controller: str, effort: float, threshold: float = 0.1
    ) -> Bool:
        return self.control_activate[controller] and abs(effort) > threshold
